      ...
      <div className="relative z-10 w-full  grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="text-white space-y-6 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xl font-bold tracking-widest text-white/90">UBCH</span>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  placeholder="รหัสพนักงาน หรือ ชื่อผู้ใช้งาน"
                />
              </div>
            ...
            <div className="mt-10 pt-6 border-t border-white/10 flex justify-between items-center text-xs text-white/50">
              ...
              >
                <span className="relative flex h-2 w-2">
                  ...
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-500 group-hover:bg-blue-400"></span>
                </span>
